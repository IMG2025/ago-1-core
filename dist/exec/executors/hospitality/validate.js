...
export function validateHospitalityInputs(inputs) {
    ...
    switch (actionRaw) {
        case "RATE_UPDATE": {
            ...
            const room_type = typeof obj.room_type === "string" && obj.room_type.trim().length > 0
                ? obj.room_type.trim()
                : undefined;
            return room_type
                ? {
